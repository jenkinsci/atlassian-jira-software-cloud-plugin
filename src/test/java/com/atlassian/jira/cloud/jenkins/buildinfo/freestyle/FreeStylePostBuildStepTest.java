...
public class FreeStylePostBuildStepTest {
	 ...
	 private static final String SITE = "example.atlassian.net";
	    ...
	    public void setUp() throws Exception {
	        ...
	        final FreestyleBuildInfoSender mockSender = mock(FreestyleBuildInfoSender.class);
	    ...
	    public void testStep() throws Exception {
	        ...
	        // when
	        final boolean response = step.perform(mockAbstractBuild, mockLauncher(), mockBuildListener());
