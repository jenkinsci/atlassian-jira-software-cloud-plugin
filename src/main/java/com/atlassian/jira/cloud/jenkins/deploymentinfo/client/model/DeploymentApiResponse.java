...
/**
 * When a deployment is submitted via the API, the response includes the list of
 * accepted deployments (which will appear in the respective Jira issue view),
 * rejected deployments (with appropriated reason on why it was not accepted),
...
public class DeploymentApiResponse {
    ...
    public DeploymentApiResponse(
            @JsonProperty("acceptedDeployments") final List<DeploymentKeyResponse> acceptedDeployments,
            @JsonProperty("rejectedDeployments") final List<RejectedDeploymentResponse> rejectedDeployments,
