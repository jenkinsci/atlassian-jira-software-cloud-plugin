...
public class JiraCloudSiteConfig extends AbstractDescribableImpl<JiraCloudSiteConfig> {
    ...
    private final String lastConnectionTest;

    // Primary constructor
// Secondary constructor
    @DataBoundConstructor
    public JiraCloudSiteConfig(
            final String site, final String webhookUrl, final String credentialsId, final String lastConnectionTest) {
        this.site = requireNonNull(site);
        this.webhookUrl = requireNonNull(webhookUrl);
        this.credentialsId = requireNonNull(credentialsId);
        this.lastConnectionTest = lastConnectionTest != null ? lastConnectionTest : "false";
    }
    ...
    public String getLastConnectionTest() {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(site, webhookUrl, credentialsId, lastConnectionTest);
    }
